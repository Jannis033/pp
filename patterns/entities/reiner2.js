patternCreator.entities.reiner2 = function() {
    ...
    ctx.strokeStyle = "rgba(0,0,0,0)";
    ctx.font = "   15px HelveticaNeue,Helvetica,Arial,sans-serif";
    ctx.transform(0.00130277, 0.0015952, 0.0015952, -0.00130277, 29.264036, 55.413362);
    ctx.save();
    ctx.strokeStyle = "rgba(0,0,0,0)";
    ctx.font = "   15px HelveticaNeue,Helvetica,Arial,sans-serif";
    ctx.beginPath();
    ctx.moveTo(7593, 8440);
    ctx.bezierCurveTo(7116, 8413, 6672, 8332, 6297, 8204);
    ctx.bezierCurveTo(6133, 8148, 6057, 8116, 5810, 8002);
    ctx.bezierCurveTo(5311, 7773, 4985, 7646, 4778, 7601);
    ctx.bezierCurveTo(4625, 7568, 4166, 7554, 3750, 7569);
    ctx.bezierCurveTo(3205, 7589, 2872, 7594, 2797, 7582);
    ctx.bezierCurveTo(2744, 7574, 2710, 7560, 2642, 7519);
    ctx.bezierCurveTo(2316, 7325, 1982, 7007, 1682, 6606);
    ctx.bezierCurveTo(1104, 5835, 648, 4870, 319, 3720);
    ctx.bezierCurveTo(291, 3624, 244, 3463, 214, 3362);
    ctx.bezierCurveTo(184, 3261, 141, 3091, 120, 2983);
    ctx.bezierCurveTo(98, 2876, 62, 2720, 40, 2636);
    ctx.bezierCurveTo(18, 2551, 0, 2460, 0, 2431);
    ctx.bezierCurveTo(0, 2356, 26, 2241, 70, 2120);
    ctx.bezierCurveTo(99, 2040, 110, 1994, 114, 1926);
    ctx.bezierCurveTo(130, 1694, 219, 1456, 368, 1246);
    ctx.bezierCurveTo(435, 1151, 633, 948, 739, 865);
    ctx.bezierCurveTo(1005, 656, 1369, 456, 1733, 321);
    ctx.bezierCurveTo(2256, 127, 2804, 26, 3465, 4);
    ctx.lineTo(3665, -3);
    ctx.lineTo(4065, 128);
    ctx.bezierCurveTo(4285, 200, 4571, 292, 4700, 334);
    ctx.bezierCurveTo(5090, 459, 5298, 529, 5450, 587);
    ctx.bezierCurveTo(5595, 643, 5646, 659, 5900, 726);
    ctx.bezierCurveTo(6031, 761, 7455, 1117, 7635, 1160);
    ctx.bezierCurveTo(7685, 1172, 7950, 1238, 8225, 1307);
    ctx.lineTo(8725, 1432);
    ctx.lineTo(8910, 1441);
    ctx.bezierCurveTo(9178, 1454, 9373, 1482, 9620, 1545);
    ctx.bezierCurveTo(10225, 1698, 10846, 2031, 11415, 2507);
    ctx.bezierCurveTo(12008, 3003, 12417, 3603, 12625, 4278);
    ctx.bezierCurveTo(12776, 4771, 12837, 5387, 12775, 5795);
    ctx.bezierCurveTo(12710, 6222, 12519, 6669, 12246, 7034);
    ctx.bezierCurveTo(12201, 7095, 12144, 7172, 12120, 7205);
    ctx.bezierCurveTo(12059, 7289, 11927, 7424, 11855, 7475);
    ctx.bezierCurveTo(11644, 7626, 11171, 7781, 10141, 8039);
    ctx.bezierCurveTo(9273, 8257, 8773, 8363, 8345, 8421);
    ctx.bezierCurveTo(8171, 8445, 7830, 8453, 7593, 8440);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.restore();
