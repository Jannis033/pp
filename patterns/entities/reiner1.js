patternCreator.entities.reiner1 = function() {
    ...
    ctx.strokeStyle = "rgba(0,0,0,0)";
    ctx.font = "   15px HelveticaNeue,Helvetica,Arial,sans-serif";
    ctx.transform(0.00210997, 0.00053831335, 0.00053831335, -0.00210997, 27.232738, 70.740516);
    ctx.save();
    ctx.strokeStyle = "rgba(0,0,0,0)";
    ctx.font = "   15px HelveticaNeue,Helvetica,Arial,sans-serif";
    ctx.beginPath();
    ctx.moveTo(1404, 10328);
    ctx.bezierCurveTo(1384, 10316, 1453, 10235, 2774, 8739);
    ctx.bezierCurveTo(3539, 7872, 4170, 7165, 4176, 7167);
    ctx.bezierCurveTo(4182, 7169, 4199, 7155, 4214, 7135);
    ctx.bezierCurveTo(4244, 7096, 4232, 7087, 4197, 7123);
    ctx.bezierCurveTo(4185, 7136, 4182, 7137, 4190, 7127);
    ctx.bezierCurveTo(4204, 7109, 4203, 7108, 4175, 7113);
    ctx.bezierCurveTo(4159, 7117, 4109, 7124, 4065, 7130);
    ctx.bezierCurveTo(4021, 7135, 3495, 7205, 2895, 7285);
    ctx.bezierCurveTo(2296, 7364, 1414, 7481, 935, 7545);
    ctx.bezierCurveTo(457, 7608, 50, 7663, 33, 7666);
    ctx.bezierCurveTo(5, 7671, 0, 7669, 0, 7653);
    ctx.bezierCurveTo(0, 7621, 53, 7549, 126, 7480);
    ctx.bezierCurveTo(353, 7268, 830, 7032, 1455, 6824);
    ctx.bezierCurveTo(1742, 6729, 2080, 6627, 2086, 6633);
    ctx.bezierCurveTo(2089, 6635, 2070, 6643, 2045, 6650);
    ctx.bezierCurveTo(2020, 6657, 2001, 6665, 2003, 6667);
    ctx.bezierCurveTo(2005, 6669, 2164, 6626, 2356, 6572);
    ctx.bezierCurveTo(2548, 6517, 3001, 6392, 3362, 6294);
    ctx.bezierCurveTo(3723, 6195, 4011, 6112, 4002, 6109);
    ctx.bezierCurveTo(3975, 6099, 4928, 5871, 5332, 5790);
    ctx.lineTo(5389, 5779);
    ctx.lineTo(5563, 5582);
    ctx.bezierCurveTo(5751, 5370, 5966, 5145, 6630, 4468);
    ctx.bezierCurveTo(7422, 3660, 7857, 3184, 7954, 3020);
    ctx.bezierCurveTo(8025, 2901, 8063, 2798, 8064, 2724);
    ctx.bezierCurveTo(8065, 2639, 8040, 2604, 7944, 2561);
    ctx.bezierCurveTo(7834, 2511, 7728, 2437, 7621, 2335);
    ctx.bezierCurveTo(7357, 2081, 7219, 1760, 7218, 1400);
    ctx.bezierCurveTo(7218, 1129, 7290, 909, 7470, 631);
    ctx.bezierCurveTo(7551, 507, 7725, 329, 7844, 249);
    ctx.bezierCurveTo(7953, 176, 8106, 101, 8213, 66);
    ctx.bezierCurveTo(8363, 18, 8445, 6, 8610, 5);
    ctx.bezierCurveTo(8775, 5, 8849, 17, 9000, 67);
    ctx.bezierCurveTo(9285, 162, 9559, 391, 9699, 650);
    ctx.bezierCurveTo(9750, 746, 9805, 912, 9821, 1018);
    ctx.bezierCurveTo(9839, 1148, 9828, 1363, 9797, 1483);
    ctx.bezierCurveTo(9766, 1598, 9699, 1745, 9634, 1838);
    ctx.bezierCurveTo(9498, 2032, 9221, 2350, 8714, 2895);
    ctx.bezierCurveTo(8131, 3520, 8046, 3614, 7779, 3935);
    ctx.bezierCurveTo(7391, 4400, 7104, 4767, 6999, 4935);
    ctx.bezierCurveTo(6868, 5143, 6750, 5426, 6750, 5530);
    ctx.bezierCurveTo(6750, 5556, 6755, 5603, 6761, 5636);
    ctx.bezierCurveTo(6772, 5691, 6778, 5701, 6854, 5778);
    ctx.bezierCurveTo(6898, 5824, 6949, 5869, 6965, 5880);
    ctx.bezierCurveTo(7013, 5910, 7138, 5947, 7277, 5972);
    ctx.bezierCurveTo(7392, 5993, 7434, 5995, 7700, 5994);
    ctx.bezierCurveTo(8003, 5994, 8152, 5984, 8740, 5924);
    ctx.bezierCurveTo(9283, 5869, 9317, 5864, 10615, 5656);
    ctx.bezierCurveTo(11026, 5590, 11083, 5583, 11400, 5554);
    ctx.bezierCurveTo(11740, 5524, 11923, 5547, 12137, 5650);
    ctx.bezierCurveTo(12472, 5809, 12697, 6097, 12776, 6462);
    ctx.bezierCurveTo(12801, 6579, 12805, 6776, 12786, 6908);
    ctx.bezierCurveTo(12722, 7340, 12467, 7669, 12038, 7875);
    ctx.bezierCurveTo(11911, 7936, 11829, 7961, 11657, 7990);
    ctx.bezierCurveTo(11364, 8040, 11012, 7987, 10770, 7858);
    ctx.bezierCurveTo(10484, 7706, 10251, 7428, 10151, 7120);
    ctx.bezierCurveTo(10090, 6934, 10069, 6689, 10099, 6525);
    ctx.bezierCurveTo(10112, 6458, 10111, 6452, 10091, 6412);
    ctx.bezierCurveTo(10053, 6338, 9958, 6299, 9765, 6279);
    ctx.bezierCurveTo(9638, 6266, 9620, 6267, 9240, 6321);
    ctx.bezierCurveTo(8833, 6378, 8352, 6461, 7585, 6605);
    ctx.bezierCurveTo(6785, 6755, 6530, 6799, 6225, 6840);
    ctx.bezierCurveTo(6099, 6857, 5982, 6876, 5965, 6882);
    ctx.bezierCurveTo(5933, 6894, 5828, 6989, 5835, 7000);
    ctx.bezierCurveTo(5842, 7012, 5466, 7372, 5119, 7685);
    ctx.bezierCurveTo(4861, 7918, 3725, 8900, 3360, 9206);
    ctx.bezierCurveTo(2633, 9815, 2116, 10155, 1712, 10290);
    ctx.bezierCurveTo(1576, 10336, 1443, 10352, 1404, 10328);
    ctx.closePath();
    ctx.moveTo(11561, 7689);
    ctx.bezierCurveTo(11721, 7673, 11793, 7655, 11905, 7602);
    ctx.bezierCurveTo(12098, 7509, 12235, 7395, 12339, 7239);
    ctx.bezierCurveTo(12511, 6983, 12539, 6596, 12405, 6323);
    ctx.bezierCurveTo(12292, 6094, 12084, 5943, 11780, 5869);
    ctx.bezierCurveTo(11621, 5831, 11450, 5837, 11170, 5891);
    ctx.bezierCurveTo(10973, 5929, 10832, 5991, 10699, 6098);
    ctx.bezierCurveTo(10425, 6319, 10329, 6657, 10442, 7010);
    ctx.bezierCurveTo(10550, 7347, 10854, 7623, 11191, 7689);
    ctx.bezierCurveTo(11254, 7702, 11441, 7702, 11561, 7689);
    ctx.closePath();
    ctx.moveTo(5827, 7006);
    ctx.bezierCurveTo(5836, 6991, 5748, 7071, 5603, 7212);
    ctx.bezierCurveTo(5535, 7277, 5480, 7333, 5480, 7336);
    ctx.bezierCurveTo(5480, 7343, 5818, 7022, 5827, 7006);
    ctx.closePath();
    ctx.moveTo(4057, 6104);
    ctx.bezierCurveTo(4054, 6101, 4045, 6100, 4038, 6103);
    ctx.bezierCurveTo(4030, 6106, 4033, 6109, 4044, 6109);
    ctx.bezierCurveTo(4055, 6110, 4061, 6107, 4057, 6104);
    ctx.closePath();
    ctx.moveTo(8605, 2321);
    ctx.bezierCurveTo(8716, 2292, 8869, 2214, 8968, 2135);
    ctx.bezierCurveTo(9055, 2065, 9232, 1878, 9308, 1775);
    ctx.bezierCurveTo(9333, 1742, 9375, 1670, 9401, 1615);
    ctx.bezierCurveTo(9524, 1359, 9544, 1080, 9455, 858);
    ctx.bezierCurveTo(9349, 597, 9063, 380, 8742, 319);
    ctx.bezierCurveTo(8643, 300, 8455, 313, 8345, 345);
    ctx.bezierCurveTo(8233, 378, 8076, 454, 7989, 519);
    ctx.bezierCurveTo(7876, 603, 7708, 809, 7621, 971);
    ctx.bezierCurveTo(7551, 1101, 7535, 1178, 7535, 1380);
    ctx.bezierCurveTo(7535, 1532, 7538, 1566, 7558, 1640);
    ctx.bezierCurveTo(7656, 2000, 7930, 2273, 8255, 2336);
    ctx.bezierCurveTo(8346, 2354, 8502, 2347, 8605, 2321);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.restore();
    ...
    ctx.font = "   15px HelveticaNeue,Helvetica,Arial,sans-serif";
    ctx.beginPath();
    ctx.moveTo(3918, 6123);
    ctx.bezierCurveTo(3925, 6120, 3934, 6121, 3937, 6124);
    ctx.bezierCurveTo(3941, 6127, 3935, 6130, 3924, 6129);
    ctx.bezierCurveTo(3913, 6129, 3910, 6126, 3918, 6123);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.restore();
    ...
    ctx.font = "   15px HelveticaNeue,Helvetica,Arial,sans-serif";
    ctx.beginPath();
    ctx.moveTo(3958, 6113);
    ctx.bezierCurveTo(3965, 6110, 3974, 6111, 3977, 6114);
    ctx.bezierCurveTo(3981, 6117, 3975, 6120, 3964, 6119);
    ctx.bezierCurveTo(3953, 6119, 3950, 6116, 3958, 6113);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.restore();
