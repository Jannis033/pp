...
entityList.set("1", { name: "Hilchenbach", texture: "hilchenbach", overlap: true, interact: efnc.e1, mode: { enabled: true, give: false, thank: false, end: false }, task: { item: "cookie", count: 5 }, text: { t1: "Du willst also in das MSS-Cafe? Mhhh, einerseits solltet ihr nicht drin sein, andererseits hab ich auch mal wieder Lust auf Kekse, bring mir 5 Stück und ich lasse dich rein!", t2: "Danke, ef gibt bestimmt noch anderer Lehrer, die Hilfe benötigen! Schau doch mal im Lehrerzimmer nach." } });
entityList.set("2", { name: "Goldi", texture: "goldi", overlap: true, interact: efnc.e2, mode: { enabled: false, give: false, thank: false, end: false }, task: { item: "key", count: 1 }, text: { t0: "Hmmmm", t1: "Hilfe wo ist mein Schlüssel?!", t2: "Oh Gott sei dank. Um mich bei dir zu ravanchieren öffne ich dir nun alle Gänge", t3: "Wie ich hörte, verlangt Herr Persel dich in seinem Büro zu sehen. Gehab dich wohl" } });
entityList.set("3", { name: "Glauben", texture: "emily", overlap: true, interact: efnc.e3, mode: { enabled: true, end: false }, text: { t1: ["Eure Epochalnoten? Ne tut mir leid ich hatte leider keine Zeit am Wochenende, aber hier ist eine Powerpoint-Präsentation, die ich für die Kursfahrt erstellt habe.", "Ja, ich hätte schon am liebsten eine Lehrerin dabei.", "Manche Kunstwerke werden auf Pornoseiten hochgeladen, weil sie auf Youtube gesperrt werden würden, da nackte Menschen zu sehen sind", "Hütet euch vor Spekulatius, davon fängt man an zu spekulieren", "Ich stehe vor dem Spiegel und sehe dort Gott!", "Lit", "#HansIstEinEhrenmann"] } });
entityList.set("4", { name: "Reiner", texture: "reiner", overlap: true, interact: efnc.e4, mode: { enabled: true, end: false }, text: { t1: "Hallo Schüler, wie ich auf meinen Kameras gesehen habe, konntest du vielen meiner Kollegen helfen, besiege mich in einer Runde Schere-Stein-Papier und wenn du gewinnen solltest, gewähre ich euch die Parkplätze unter der Sporthalle. ", t2: "Schade, vielleicht beim nächsten Mal", t3: "Oh du hast mich besiegt! Normalerweise ginge es an dieser Stelle weiter mit dem Spiel, aber soweit sind wir noch nicht gekommen..." } });
...
entityList.set("E1", { name: "Müller", texture: "glauben", rotate: false, overlap: true, follow: efnc.E1, rotation: 270, text: { t1: "Sammel 5 Desinfektionsmittel und du bist immun!", t2: "Besser ist das!" }, task: { item: "desi", count: 5 } });
